    ...
    <div className='w-full flex justify-center items-center mt-20'>
      <div className='w-full max-w-[500px] flex flex-col justify-center items-center py-10 px-10 mx-5 rounded-md border-4 border-green-500'>
        ...
        <label htmlFor="username" className='flex flex-col self-start w-full mt-10'>
          Nombre de usuario: 
          <input type="text" name='username' id='username' className='bg-transparent border border-green-500 rounded-md h-[40px] pl-4 outline-none mt-3' placeholder='Ingrese su nombre de usuario'/>
        </label>
        <label htmlFor="password" className='flex flex-col self-start w-full mt-10'>
          Contraseña: 
          <input type="password" name='password' id='password' className='bg-transparent border border-green-500 rounded-md h-[40px] pl-4 outline-none mt-3' placeholder='Ingrese su contraseña'/>
        </label>
